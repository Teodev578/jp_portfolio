export const translations = {
    fr: {
        ...
        nav_projects: "Projet",
        nav_contact: "Contact",
        hero_headline: "Le Préparateur",
        hero_sub_intro: "Par <strong>Jean-Pierre Agbo</strong> Spécialiste en stratégie marketing et préparation automobile.",
        hero_description: "Fort d’un Master en Stratégie Marketing, j’ai fondé mon entreprise <strong>Le Préparateur</strong> pour mettre mon expertise et ma rigueur au service de la valorisation de votre véhicule.",
        hero_contact_btn: "Contactez-moi",
        hero_insta_btn: "Voir mes réalisations",
...
<p>Ce site n'utilise aucun cookie tiers de profilage ou publicitaire. Seules les préférences fonctionnelles (comme le choix de la langue et du thème) peuvent être temporairement conservées localement dans votre navigateur.</p>`,
    ...
    en: {
        ...
        hero_description: "With a Master's degree in Marketing Strategy, I founded my company <strong>Le Préparateur</strong> to put my expertise and rigor at the service of your vehicle's valuation.",
        hero_contact_btn: "Contact me",
        hero_insta_btn: "View my projects",
